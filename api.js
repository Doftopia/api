    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (req.query.effect) {
                    effects = Array.isArray(req.query.effect)
                        ? req.query.effect
                        : [req.query.effect];
                ...
                if (req.query.category) {
                    ...
                    categoryFilters = categories
                        .map(function () { return "items.type like ?"; })
                        .join(" OR ");
...
app.get("/achievements", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var itemQuery, queryParams, _a, results, _, error_4;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 3:
                error_4 = _b.sent();
                console.error("Error fetching achievements: ".concat(error_4));
                res.status(500).json({ error: "Internal Server Error" });
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
...
app.get("/achievements-categories", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var itemQuery, queryParams, _a, results, _, error_5;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                itemQuery = "SELECT * from achievements_categories";
                queryParams = [];
                if (req.query.Id) {
                    itemQuery += " WHERE id = ?";
                    queryParams.push(req.query.id);
            ...
            case 3:
                error_5 = _b.sent();
                console.error("Error fetching achievements categories: ".concat(error_5));
                res.status(500).json({ error: "Internal Server Error" });
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
...
app.get("/achievements-objectives", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var itemQuery, queryParams, _a, results, _, error_6;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                itemQuery = "SELECT * from achievement_objectives";
                queryParams = [];
                if (req.query.id) {
            ...
            case 3:
                error_6 = _b.sent();
                console.error("Error fetching achievements objectives: ".concat(error_6));
                res.status(500).json({ error: "Internal Server Error" });
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
...
app.get("/recipes", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var itemQuery, queryParams, groupedData, recipe, previousItemId, _a, results, fields, rows, error_7;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 3:
                error_7 = _b.sent();
                console.error("Error fetching recipes: ".concat(error_7));
                res.status(500).json({ error: "Internal Server Error" });
                return [2 /*return*/];
            case 4: return [2 /*return*/];
        }
...
app.get("/itemSets", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var itemQuery, queryParams, groupedData, charac, nmbItems, previousSetId, previousNmbItems, _a, results, fields, rows_1, error_8;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 2:
                ...
                groupedData.push({
                    nmbItems: nmbItems,
                    setName: rows_1[rows_1.length - 1].setName,
                    setId: rows_1[rows_1.length - 1].setId,
                    setLevel: rows_1[rows_1.length - 1].setLevel,
                });
                res.json({ data: groupedData });
                return [3 /*break*/, 4];
            case 3:
                error_8 = _b.sent();
                console.error("Error fetching sets: ".concat(error_8));
                res.status(500).json({ error: "Internal Server Error" });
                return [2 /*return*/];
            case 4: return [2 /*return*/];
        }
...
app.get("/mobs", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var groupedData, mobCharac, base_limit, base_offset, previousMobID, itemQuery, queryParams, previousMobName, previousMobImg, ids, placeholders, limit, _a, results, fields, rows_2, error_9;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                groupedData = [];
            ...
            case 2:
                ...
                results.forEach(function (result, index) {
                    ...
                    if (result.id != previousMobID ||
                        (result.id == rows_2[rows_2.length - 1].id &&
                            result.lifePoints == rows_2[rows_2.length - 1].lifePoints)) {
                        groupedData.push({
            ...
            case 3:
                error_9 = _b.sent();
                console.error("Error fetching mobs: ".concat(error_9));
                res.status(500).json({ error: "Internal Server Error" });
                return [2 /*return*/];
            case 4: return [2 /*return*/];
        }
...
app.get("/mobs-drop", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var previousMobId, drops, groupedData, itemQuery, queryParams, _a, results, _, rows, error_10;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                previousMobId = 0;
            ...
            case 3:
                error_10 = _b.sent();
                console.error("Error fetching mobs drop: ".concat(error_10));
                res.status(500).json({ error: "Internal Server Error" });
                return [2 /*return*/];
            case 4: return [2 /*return*/];
        }
...
app.get("/quests", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                error_11 = _b.sent();
                console.error("Error fetching quests: ".concat(error_11));
                res.status(500).json({ error: "Internal Server Error" });
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
...
app.get("/quests-categories", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var itemQuery, queryParams, _a, results, _, error_12;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                itemQuery = "SELECT quest_categories.id AS questId,\n  quest_categories.name AS questCategory,\n  quest_categories.order AS 'order'\n  FROM quest_categories;";
                queryParams = [];
                if (req.query.id) {
